      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <FormControl
            ...
            alignItems="center"
            mb="4"
            isInvalid={!!formik.errors?.is_anonymous}
          >
            <FormLabel htmlFor="switch-is_anonymous">Is Anonymous</FormLabel>
            <Switch
              id="switch-is_anonymous"
              name="is_anonymous"
              onChange={formik.handleChange}
              value={formik.values?.is_anonymous ? 1 : 0}
            />
            {formik.errors?.is_anonymous && <FormErrorMessage>{formik.errors?.is_anonymous}</FormErrorMessage>}
          </FormControl>
